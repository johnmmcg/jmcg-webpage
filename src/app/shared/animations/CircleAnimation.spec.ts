...
describe('CircleAnimation', () => {
  ...
  test('should animate', () => {
    ...
    expect(context.beginPath).toHaveBeenCalledTimes(25);
    expect(context.arc).toHaveBeenCalledTimes(25);
    expect(context.fill).toHaveBeenCalledTimes(25);
    expect(context.closePath).toHaveBeenCalledTimes(25);
